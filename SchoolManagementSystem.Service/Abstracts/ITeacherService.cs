...
namespace SchoolManagementSystem.Service.Abstracts
{
    public interface ITeacherService
    {
        ...
        public Task<bool> CreateTeacherAsync(int PersonId, decimal Salary, bool PermanentWork);
        public Task<bool> UpdateTeacherAsync(int PersonId, decimal? Salary = null, bool? PermanentWork = null, string? NationalCardNumber = null, string? FirstName = null, string? LastName = null, bool? Gender = null,
