...
namespace SchoolManagementSystem.Infrastructure.Abstracts
{
    public interface IPartOfScheduleRepository : IGenericRepository<PartOfSchedule>
    {
        ...
        //public bool UpdatePartOfScheduleByQuery(int PersonId, decimal? Salary = null, bool? PermanentWork = null);
        //public Task<bool> AddNewPartOfScheduleByPerson(int PersonId, decimal Salary, bool PermanentWork);
    }
}
